...
//#define IDR_QUICK_SEEK_ICO      1540
#define IDR_QUICK_SEEK          1541
...
#define IDD_LINE_DETAIL_INFO_DLG     3500
#define IDC_STATIC_RECORD_NO        (IDD_LINE_DETAIL_INFO_DLG + 1)
#define IDC_EDIT_RECORD_NO          (IDD_LINE_DETAIL_INFO_DLG + 2)
#define IDC_STATIC_LAYER_NAME       (IDD_LINE_DETAIL_INFO_DLG + 3)
#define IDC_EDIT_LAYER_NAME         (IDD_LINE_DETAIL_INFO_DLG + 4)
#define IDC_STATIC_OUTPUT_TIME      (IDD_LINE_DETAIL_INFO_DLG + 5)
#define IDC_EDIT_OUTPUT_TIME        (IDD_LINE_DETAIL_INFO_DLG + 6)
#define IDC_STATIC_LOG_TYPE         (IDD_LINE_DETAIL_INFO_DLG + 7)
#define IDC_EDIT_LOG_TYPE           (IDD_LINE_DETAIL_INFO_DLG + 8)
#define IDC_STATIC_FILE_NAME        (IDD_LINE_DETAIL_INFO_DLG + 9)
#define IDC_EDIT_FILE_NAME          (IDD_LINE_DETAIL_INFO_DLG + 10)
#define IDC_EDIT_LINE_NO            (IDD_LINE_DETAIL_INFO_DLG + 11)
#define IDC_STATIC_LINE_NO          (IDD_LINE_DETAIL_INFO_DLG + 12)
#define IDC_EDIT_FUN_NAME           (IDD_LINE_DETAIL_INFO_DLG + 13)
#define IDC_STATIC_FUN_NAME         (IDD_LINE_DETAIL_INFO_DLG + 14)
#define IDC_STATIC_THREAD_NO        (IDD_LINE_DETAIL_INFO_DLG + 15)
#define IDC_EDIT_THREAD_NO          (IDD_LINE_DETAIL_INFO_DLG + 16)
#define IDC_STATIC_LOG_CONTENT      (IDD_LINE_DETAIL_INFO_DLG + 17)
#define IDC_EDIT_LOG_CONTENT        (IDD_LINE_DETAIL_INFO_DLG + 18)
...
#define NOTEPADPLUS_USER_INTERNAL     (WM_USER + 0000)
	...
	#define NPPM_INTERNAL_MAKERLINE                 (NOTEPADPLUS_USER_INTERNAL + 40)
	#define NPPM_INTERNAL_CLEARMAKERLINE            (NOTEPADPLUS_USER_INTERNAL + 41)
